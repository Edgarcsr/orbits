    ...
    <div className="min-h-screen min-w-screen flex items-center justify-center flex-col gap-4">
      <div className="flex flex-col items-center justify-center">
        ...
        <p className="text-xs text-muted-foreground max-w-80 text-center">
         Be part of the Orbits community and start sharing your files with ease!
        </p>
      </div>
      ...
      <form>
        <FieldGroup className='w-80'>
          ...
          <Button type="submit" className="w-full bg-amber-400 hover:bg-amber-300 font-normal p-4">
            Create Account
            <ArrowRight />
          </Button>
        </FieldGroup>
      </form>
      <p className='text-xs text-muted-foreground'>Already have an account? <Link href="/auth/sign-in" className="text-foreground hover:underline">Sign in</Link></p>
    </div>
  )
}
